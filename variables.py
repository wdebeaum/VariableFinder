...
class WMVariable:
    ...
    def __init__(self, resources_path):
        ...
        variables_path = resources_path + '/dsatVars.xlsx'
        ...
        self.load_vars(variables_path, crop_codes_path, management_codes_path, metadata_codes_path, other_codes_path,
                       country_codes_path)
    ...
    def load_vars(self, vars_path, crop_codes_path, management_codes_path, metadata_codes_path, other_codes_path, county_codes_path):
        """Load and index variable and code tables."""
        country_codes = pd.read_csv(county_codes_path)[
